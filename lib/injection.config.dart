...
import 'package:expedientes_clinicos/infraestructure/medicine/pharmaceutical_form/pharmaceutical_form_repository.dart'
    as _i19;
import 'package:expedientes_clinicos/injectable_modules.dart' as _i39;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i30.TimeIntervalFormBloc>(
        () => _i30.TimeIntervalFormBloc(gh<_i31.ITimeIntervalRepository>()));
    gh.factory<_i32.TimeIntervalWatcherBloc>(
        () => _i32.TimeIntervalWatcherBloc(gh<_i31.ITimeIntervalRepository>()));
    gh.factory<_i33.AdministrationRouteActorBloc>(() =>
        _i33.AdministrationRouteActorBloc(
            gh<_i10.IAdministrationRouteRepository>()));
    gh.factory<_i34.AdministrationRouteFormBloc>(() =>
        _i34.AdministrationRouteFormBloc(
            gh<_i10.IAdministrationRouteRepository>()));
    gh.factory<_i35.AdministrationRouteWatcherBloc>(() =>
        _i35.AdministrationRouteWatcherBloc(
            gh<_i10.IAdministrationRouteRepository>()));
    gh.factory<_i36.CategoryActorBloc>(
        () => _i36.CategoryActorBloc(gh<_i12.ICategoryRepository>()));
    gh.factory<_i37.CategoryFormBloc>(
        () => _i37.CategoryFormBloc(gh<_i12.ICategoryRepository>()));
    gh.factory<_i38.CategoryWatcherBloc>(
        () => _i38.CategoryWatcherBloc(gh<_i12.ICategoryRepository>()));
    return this;
  }
}
