...
import 'package:expedientes_clinicos/infraestructure/medicine/medicine_repository.dart'
    as _i17;
import 'package:expedientes_clinicos/injectable_modules.dart' as _i28;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i18.MeasureUnitFormBloc>(
        () => _i18.MeasureUnitFormBloc(gh<_i14.IMeasureUnitRepository>()));
    gh.factory<_i19.MeasureUnitWatcherBloc>(
        () => _i19.MeasureUnitWatcherBloc(gh<_i14.IMeasureUnitRepository>()));
    gh.factory<_i20.MedicineFormBloc>(
        () => _i20.MedicineFormBloc(gh<_i16.IMedicineRepository>()));
    gh.factory<_i21.MedicineWatcherBloc>(
        () => _i21.MedicineWatcherBloc(gh<_i16.IMedicineRepository>()));
    gh.factory<_i22.StateRendererBloc>(() => _i22.StateRendererBloc());
    gh.factory<_i23.AdministrationRouteFormBloc>(() =>
        _i23.AdministrationRouteFormBloc(
            gh<_i10.IAdministrationRouteRepository>()));
    gh.factory<_i24.AdministrationRouteWatcherBloc>(() =>
        _i24.AdministrationRouteWatcherBloc(
            gh<_i10.IAdministrationRouteRepository>()));
    gh.factory<_i25.CategoryActorBloc>(
        () => _i25.CategoryActorBloc(gh<_i12.ICategoryRepository>()));
    gh.factory<_i26.CategoryFormBloc>(
        () => _i26.CategoryFormBloc(gh<_i12.ICategoryRepository>()));
    gh.factory<_i27.CategoryWatcherBloc>(
        () => _i27.CategoryWatcherBloc(gh<_i12.ICategoryRepository>()));
    return this;
  }
}
