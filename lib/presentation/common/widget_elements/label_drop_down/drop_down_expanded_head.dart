...
class DropDownExpandedSearchHead extends StatefulWidget {
  TextEditingController searchFieldController;
  List<DropdownExpandedItemViewModel> listElements;
  ...
  Function onSelected;
  String hintText;
  DropdownExpandedItemViewModel element;
  DropDownExpandedSearchHead(
      {super.key,
  ...
  @override
  State<DropDownExpandedSearchHead> createState() =>
      _DropDownExpandedSearchHeadState();
}

class _DropDownExpandedSearchHeadState
    extends State<DropDownExpandedSearchHead> {
  ...
  List<DropdownExpandedItemViewModel> _oldListElements = [];
  ...
  @override
  void didUpdateWidget(DropDownExpandedSearchHead oldWidget) {
