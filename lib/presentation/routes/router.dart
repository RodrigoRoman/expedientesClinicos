...
import 'package:expedientes_clinicos/presentation/patient_section/patient_section_page.dart';
...
class AppRouter extends _$AppRouter {
  List<AutoRoute> get routes => [
        AutoRoute(page: PatientSectionPageRoute.page, initial: true),
        AutoRoute(page: PatientVisitPageRoute.page),
